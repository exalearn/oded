...
def findIdealSequence(syncThresholds, isSynchronized, MOCUInitial, K_max, w, N, h , MVirtual, MReal, TVirtual, TReal, aLowerBoundIn, aUpperBoundIn, it_idx, update_cnt, iterative = True):
