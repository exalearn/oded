...
def main( n_theta , n_psi , n_mc , n_s , n_experiment , n_oed , i , oed_type ):
...
if __name__ == '__main__':
    ...
    parser.add_argument("--index_run", "-i", help="index of OED runs")
    ...
    if args.index_run is None:
        sys.exit("\nIndex of OED runs is not provided.\n")
    else:
        i = int(args.index_run)
    ...
    main( n_theta , n_psi , n_mc , n_s , n_experiment , n_oed , i , oed_type )
